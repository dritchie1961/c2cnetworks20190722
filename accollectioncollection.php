...
$SQLCode2 = "select * from c2cnetworks.lppasset where status = 'collection' and peopleid = '" . $peopleid . "'";
...
/*
if ($conn->is_select_mode()) {
    $conn->render_sql($SQLCode1, "CompanyID", "CompanyName,Companyaddress,CompanyPhoneNumber,CompanyLink");
} else {
    //    $conn->render_sql($SQLCode2, "CompanyID", "CompanyName,Companyaddress,CompanyPhoneNumber");
    $conn->render_table("pevm.Company", "CompanyID", "CompanyName,Companyaddress,CompanyPhoneNumber");
}
*/
