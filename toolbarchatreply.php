...
<body>
	...
	<script>
		...
		mytoolbar.addButton("reply", 1, "Reply", null, null);	
...
alert("TBD - replying to chat");
		        	
// need to use the NEW chat form, but pre-populate subject information ...
					...
					myform.send("../c2cnetworks/cpc2cchat.php" + abcde);	
		         	break;					  		
...
//		chatid, datetime, fromid, toid, lppassetid, subject, description

		
			formData = [
				{type: "settings", position: "label-left", labelWidth: 150, inputWidth: 300},
		    	{type: "input", name: "chatid", label: "Chat ID"},
		     	{type: "input", name: "datetime", label: "Date"},		    	
	...
	//		alert('chat id is xx : ' + chatid);
						
			myform.load("../c2cnetworks/acc2cchatreply.php?id=" + chatid);
		   	mydp = new dataProcessor("../c2cnetworks/acc2cchatreply.php");
		   	mydp.init(myform);	   	
