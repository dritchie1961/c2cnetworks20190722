    ...
    var mytoolbar, mytabbar;    
	  ...
	  //  		{type: "select", name: "peoplestatus", label: "Status"}, options:[
	     ...
	     // 	  	{type: "select", label: "Status", options:[    		   
				...
				{type: "button", value: "Save", name: "process"},
...
//			mygrid.setColTypes("ro,ro");
			...
			mygrid.init();
			mygrid.load("../c2cnetworks/acnewuserrequestsrejected.php");
			mydp = new dataProcessor("../c2cnetworks/acnewuserrequestsrejected.php");			
			mydp.init(mygrid);
